...
const navStructure: NavEntry[] = [
  ...
  },
  {
    ...
    icon: '🤖',
    items: [
      { title: 'Топики',   path: '/telegram/topics' },
      { title: 'Посты',    path: '/telegram/posts' },
      { title: 'История',  path: '/telegram/history' },
    ],
  },
  {
    type: 'group',
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'ALV France',  path: '/parsing/avl-france' },
      ...
      { title: 'SoundTrade',  path: '/parsing/soundtrade' },
      { title: 'Kinxsound',   path: '/parsing/kinxsound' },
      { title: 'KinxConnect', path: '/parsing/kinxconnect' },
    ],
  },
  {
    type: 'link',
